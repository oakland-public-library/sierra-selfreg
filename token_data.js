...
tdata.agreement_note_child = {
    eng:"For parents/legal guardians:<br /><ul><li>Your child’s card is for your child’s use only, and your child must be present to get their card.</li>  <li>Your child’s library record (like yours) is private by law. For children 8 and up, the library cannot tell you what your child has checked out, except when a fee is owed.</li>  <li>The Library cannot limit access to any items in the library, including computers, for your child.  Your child can use computers even if they do not have a library card.</li>  <li>If your child is under 8 years old, they must be closely supervised by a parent/legal guardian or responsible caregiver and may not be left unattended in the library.</li></ul>",
